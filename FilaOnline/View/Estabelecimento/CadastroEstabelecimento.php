			...
			<div class="signup-box">
				...
				<form action="../../Controller/EstabelecimentoController?action=create_conta" method="post">
					...
					<div class="form-group">
						...
						<button type="button" class="btnsenha" name="btnsenha" onclick="togglePass()" id="btnsenha"><svg
								xmlns="http://www.w3.org/2000/svg" height="12px" viewBox="0 -960 960 960" width="24px"
								fill="#000000">
								<path
