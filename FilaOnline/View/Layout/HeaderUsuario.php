    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            ...
            <?php if (!isset($_SESSION['user_id'])) {
                echo '<a class="nav-item nav-link" href="../Usuario/Login.php">Login</a>';
            }
            ?>
            <a class="nav-item nav-link"
                href="../../Controller/EstabelecimentoController?action=readall_estabelecimento">Estabelecimentos</a>
